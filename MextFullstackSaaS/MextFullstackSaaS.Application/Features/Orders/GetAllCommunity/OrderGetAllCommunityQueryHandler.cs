...
namespace MextFullstackSaaS.Application.Features.Orders.GetAllCommunity
{
    internal class OrderGetAllCommunityQueryHandler : IRequestHandler<OrderGetAllCommunityQuery, List<string>>
    {
